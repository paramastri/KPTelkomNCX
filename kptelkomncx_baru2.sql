...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 24, 2020 at 12:08 AM
...
CREATE TABLE `admin` (
  `id` int(11) NOT NULL,
  `username` varchar(225) CHARACTER SET latin1 DEFAULT NULL,
...
(1, 'admin', '$2y$12$OUIwY2I5S2dPMnR1ZjZZM.89fWg9JvVkmQRvgIknvHxyFCEB/gqI.'),
(2, 'putri', '$2y$12$Q1EzZDIxNzk3VG01djh0WOlm3BpcGrYljUyVkbKh9sB.f4pS19s0C');
